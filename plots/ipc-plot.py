...
lru_data, drrip_data, ship_data, hawkeye_data, rlr_data, srrip_data, mab_data = parse_ipc()
...
plt.bar(index + 5 * bar_width, mab_values, bar_width, label='Micro-Armed Bandit')
